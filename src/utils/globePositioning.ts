// Shared 3D-positioning math for placing hotdog pins on the globe.
// Extracted verbatim from useHotdogsLight — the constants here are load-bearing
// (see mem://architecture/3d-globe-hotdog-rendering-strategy). Do not "tidy" them.
...
export function applyOverlapOffsets(
